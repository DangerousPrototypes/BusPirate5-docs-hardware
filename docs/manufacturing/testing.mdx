...
- Insert an SD card. If **a formatted and mountable SD card is not inserted the SD card test will fail**. 

:::caution
The test will work without an SD card, but the SD card section of the self-test will fail.
:::
